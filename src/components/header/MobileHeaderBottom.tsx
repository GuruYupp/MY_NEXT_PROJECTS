...
export default function MobileHeaderBottom({ menus,headerGradient }: props): JSX.Element {
  ...
  return <div className={`${styles.mobile_header_bottom} ${headerGradient ? styles.hasGradient : styles.noGradient
      }`}>
    {subMenus.map((menu, index) => (<Link href={`${menu.targetPath}`} key={index}>
