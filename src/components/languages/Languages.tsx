    ...
    <div className={`${styles.languages_container}`}>
      ...
      <div className={`${styles.languages_top}`}>
        ...
        <div className={`${styles.languages_buttons}`}>
          <span className={`${styles.btn}`} onClick={handleSelectAll}>
            select all
          </span>
          <span className={`${styles.divider}`}></span>
          <span className={`${styles.btn}`} onClick={handleClearAll}>
            clear all
          </span>
        </div>
      </div>
      ...
      <div className={`${styles.languages_footer}`}>
        ...
        {languageState.selectedCount === 0 && (
          <p className={`${styles.languages_error_text}`}>
            {" "}
