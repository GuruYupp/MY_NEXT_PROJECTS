...
import styles from "./ExpandActionPoster.module.scss";
import { cardPropsInterface } from "../../cardtype";
import appConfig from "@/app.config";
import CardHOC from "../../CardHOC";
const ExpandActionPoster: FC<cardPropsInterface> = (props) => {
  const {
    setcardImageRef,
    cardImage,
    partnerIcon,
  ...
  return (
    <div className={`${styles.expand_action_poster}`}>
...
export default CardHOC(ExpandActionPoster);
