...
const pageRestrictionSlice = createSlice({
  ...
  initialState,
  reducers:{
    enableRestrictionpage:(state,action:PayloadAction<{token:string}>)=>{
...
export const { enableRestrictionpage, disableRestrictionpage,resetViewRestrictions } = pageRestrictionSlice.actions
